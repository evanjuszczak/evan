  ...
  return (
    <div className="max-w-2xl mx-auto px-6 pt-24">
      ...
      <div className="space-y-8">
        <FadeIn delay={100}>
          <div>
            <h2 className="text-xl font-semibold mb-4 dark:text-white">Background</h2>
        ...
        <FadeIn delay={200}>
          <div>
            <h2 className="text-xl font-semibold mb-4 dark:text-white">Philosophy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <FadeIn delay={300}>
          <div>
            <h2 className="text-xl font-semibold mb-4 dark:text-white">Interests</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
